...
/// Callers can lookup localized strings with an instance of CommonLocalizations returned
/// by `CommonLocalizations.of(context)`.
///
...
abstract class CommonLocalizations {
  ...
  static const LocalizationsDelegate<CommonLocalizations> delegate = _AppLocalizationsDelegate();
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<CommonLocalizations> {
  ...
  Future<CommonLocalizations> load(Locale locale) {
    return SynchronousFuture<CommonLocalizations>(lookupAppLocalizations(locale));
  }
...
CommonLocalizations lookupAppLocalizations(Locale locale) {


  // Lookup logic when only language code is specified.
  switch (locale.languageCode) {
    case 'cs': return CommonLocalizationsCs();
